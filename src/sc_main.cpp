...
#include "CLIParser.h"
const std::string core_path{"vp.pulpissimo-soc.core_complex"};
...
int sc_main(int argc, char *argv[]) {
  ...
  scc::configurable_tracer trace(
      parser.get<std::string>("trace-file"),
  ...
  ///////////////////////////////////////////////////////////////////////////
  auto i_system = scc::make_unique<tgc_vp::VP>("vp");
  ///////////////////////////////////////////////////////////////////////////
